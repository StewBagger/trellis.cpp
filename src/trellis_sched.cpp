...
// The DiT graphs are built with ggml_new_graph_custom(ctx, 32768, ...); the scheduler's
// internal hash tables have to cover the largest graph we will hand it.
constexpr size_t kSchedGraphSize = 40960;
